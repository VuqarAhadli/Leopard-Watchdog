...
/*	Method : port_scanner_main
 *	
 *	DISABLED - Use port_scanner_wrapper.h functions instead
 *	Arguments:
 *		argc : No of arguments from the command line
 *		argv : All command line arguments are stored as an array
 *		
 *	This function is replaced by the wrapper interface for CLI integration.
 */
/* DISABLED - port_scanner_main function removed */
